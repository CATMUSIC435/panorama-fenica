...
export const mockScenes: Scene[] = [
  {
    ...
    hotspots: [
      ...
      { id: 'h11', type: 'info', position: [-30.18, -2.61, -77.13], title: 'Lotte Mart & BVQT Becamex', description: '15 phút', lineHeight: 320 },
      { id: 'h7', type: 'info', position: [-50.51, -0.62, -55.44], title: 'KCN Đồng An', description: '10 phút', lineHeight: 220 },
      { id: 'h8', type: 'info', position: [-28.50, -0.94, -45.40], title: 'KCX Linh Trung 2', description: '15 phút', lineHeight: 140 },
      { id: 'h3', type: 'info', position: [-17.83, -4.78, -51.77], title: 'KCN VSIP 1', description: '6 phút', lineHeight: 190 },
      ...
      { id: 'h15', type: 'info', position: [63.02, -5.23, -70.59], title: 'Tiểu học An Phú 3', description: '5 phút', lineHeight: 40 },
      { id: 'h16', type: 'info', position: [89.66, -7.12, -46.65], title: 'THCS Nguyễn Văn Trỗi & TH An Phú 1', description: '6 phút', lineHeight: 320 },
      { id: 'h19', type: 'info', position: [72.70, -5.44, 40.91], title: 'Chợ Phú An', description: '5 phút', lineHeight: 150 },
