...
export const mockScenes: Scene[] = [
  {
    ...
    hotspots: [
      { id: 'h18', type: 'info', position: [-144.97, -8.75, -23.60], title: 'Ga S12', description: '5 phút', lineHeight: 120 },
      ...
      { id: 'h9', type: 'info', position: [3.21, -1.66, -45.41], title: 'Aeon Mall', description: '14 phút', lineHeight: 100 },
      { id: 'h10', type: 'info', position: [5.67, -1.87, -60.38], title: 'Sân Golf Sông Bé', description: '14 phút', lineHeight: 150 },
      ...
      { id: 'h16', type: 'info', position: [98.42, -8.05, -22.68], title: 'THCS Nguyễn Văn Trỗi & TH An Phú 1', description: '6 phút', lineHeight: 200 },
      { id: 'h19', type: 'info', position: [72.70, -5.44, 40.91], title: 'Chợ Phú An', description: '5 phút', lineHeight: 120 },
      ...
      { id: 'h25', type: 'info', position: [-94.63, -0.96, 24.26], title: 'KCN Tân Đông Hiệp', description: '8 phút', lineHeight: 150 },
      { id: 'h26', type: 'info', position: [-116.68, 0.30, 3.50], title: 'Làng Đại học', description: '16 phút', lineHeight: 160 },
      ...
      { id: 'h31', type: 'info', position: [173.62, -40.00, -96.03], title: 'CAO TỐC TPHCM – TDM - CT', description: 'LỘ GIỚI 60 MÉT - 10 LÀN XE', lineHeight: 140 },
      { id: 'h32', type: 'info', position: [-31.34, -0.34, 33.43], title: 'Cụm công nghiệp', description: '10 phút', lineHeight: 140 },
      { id: 'h24', type: 'info', position: [-45.05, 0.00, 28.48], title: 'THPT Nguyễn Thị Minh Khai & THCS Tân Đông Hiệp B', description: '7 phút', lineHeight: 300 },
      { id: 'h33', type: 'info', position: [90.17, -11.76, -44.68], title: 'Tiểu học an Phú 3', description: '6 phút', lineHeight: 140 },
      { id: 'h34', type: 'info', position: [192.25, -13.63, 61.81], title: 'Chợ Phú phong', description: '5 phút', lineHeight: 140 },
      { id: 'h35', type: 'info', position: [197.96, -17.88, 38.19], title: 'Điện máy chợ lớn', description: '4 phút', lineHeight: 100 },
